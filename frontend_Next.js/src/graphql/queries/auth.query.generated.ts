...
export type GetProfileQuery = { __typename?: 'Query', getProfile: { __typename?: 'User', id: string, username: string, email: string, role: Types.Role, isTwoFAEnabled: boolean, profile?: { __typename?: 'Profile', bio: string, avatar: string } | null } };
